  ...
  return (
    <section className="px-4 py-16 sm:px-6 sm:py-20">
      <div
        ...
        className="mx-auto w-full max-w-6xl rounded-2xl bg-linear-to-r from-purple-600/20 to-blue-500/30 p-px"
      >
        <div className="flex flex-col items-center justify-center rounded-[15px] bg-linear-to-r from-[#F3EAFF] to-[#E1EFFF] px-5 py-12 text-center sm:px-8 md:py-16">
          ...
          <p className="text-slate-500 mt-2 max-w-lg max-md:text-sm">
            Get comfortable, reliable and personalized dental treatment from
