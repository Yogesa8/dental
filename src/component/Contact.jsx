...
const Contact = () => {
  ...
  return (
    <section
      ...
      className="bg-[#FFFFFF] flex min-h-screen w-full flex-col items-center justify-center gap-6 px-4 py-16 sm:px-6 sm:py-20 lg:px-10 xl:px-16"
    >
      ...
      <p className="mx-auto max-w-md text-center text-sm leading-6 text-zinc-600 sm:text-base">
        Schedule your appointment today and let our dental team take care of your smile.
      </p>
