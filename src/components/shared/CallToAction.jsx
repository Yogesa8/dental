...
const CallToAction = () => {
  return (
    <section
      ...
      className="flex w-full flex-col items-center justify-center gap-6 px-4 py-16 sm:px-6 sm:py-20 lg:px-10 xl:px-16 bg-[#FFFFFF]"
    >
      ...
      <div className="flex w-full max-w-5xl flex-col items-center justify-around rounded-2xl border border-gray-200 bg-white px-5 py-14 sm:px-8 sm:py-20">
        ...
        <div className="mt-6 flex w-full max-w-sm flex-col items-stretch gap-3 text-sm sm:w-auto sm:max-w-none sm:flex-row sm:items-center sm:gap-4">
          <a
            href="https://www.google.com/maps/search/?api=1&query=Shop+No.+72%2C+Sector+5%2C+Opp.+BMG+Mall%2C+Rewari%2C+Haryana+123401"
            target="_blank"
            rel="noreferrer"
